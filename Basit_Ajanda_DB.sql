...
/****** Object:  Database [BASIT_AJANDA_DB]    Script Date: 19.12.2021 21:22:48 ******/
CREATE DATABASE [BASIT_AJANDA_DB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'BASIT_AJANDA_DB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\BASIT_AJANDA_DB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'BASIT_AJANDA_DB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\BASIT_AJANDA_DB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [BASIT_AJANDA_DB] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
